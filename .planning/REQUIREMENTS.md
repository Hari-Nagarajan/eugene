...
- [ ] **SCOR-01**: Point system (+10 host, +5 port, +15 service, +20 OS, +25 vuln, +50 cred, +75 login, +150 priv esc, +200 RCE, +100 data exfil)
- [ ] **SCOR-02**: Detection penalties (-100 per detection event)
- [ ] **SCOR-03**: EV-based risk gating (proceed with exploit only if expected value > 0)
- [ ] **SCOR-04**: Score event logging with action, points, risk level, and detection status
